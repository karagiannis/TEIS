...
-- ***************************************************************************
-- Generated on "10/09/2016 00:19:06"
                                                            
-- Vhdl Test Bench template for design  :  uppgift_vhdl_4_Mealy_Moore
-- 
...
ENTITY uppgift_vhdl_4_Mealy_Moore_vhd_tst IS
END uppgift_vhdl_4_Mealy_Moore_vhd_tst;
ARCHITECTURE uppgift_vhdl_4_Mealy_Moore_arch OF uppgift_vhdl_4_Mealy_Moore_vhd_tst IS
-- constants                                                 
-- signals                                                   
...
COMPONENT uppgift_vhdl_4_Mealy_Moore
	PORT (
	clk : IN STD_LOGIC;
...
WAIT;                                                        
END PROCESS init;                                        
END uppgift_vhdl_4_Mealy_Moore_arch;
