...
-- Do file: 
-- Description:
-- 	Mealy state machine "Door without lock"
-- 
-- In_signals:
-- Insignaler:
-- KEY(0)  pushed = Close
...
end entity uppgift_vhdl_4_Mealy;


architecture rtl of uppgift_vhdl_4_Mealy is
...
begin
      ...
      state_changer: process(clk, reset_n)
		...
		output_changer:process (state, key0_close,key1_open)
		begin	
					case state is					
						when opened =>
							if key0_close='0' then
							   led0_open <= '0'; --door is open
								led1_close <= '1';
							else
