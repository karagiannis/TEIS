...
ENTITY 	uppgift_vhdl_4_Mealy IS
    PORT (
	clk : IN std_logic;
...
ARCHITECTURE structure OF uppgift_vhdl_4_Mealy IS
...
SIGNAL \ALT_INV_led0_open~0_combout\ : std_logic;
...
\ALT_INV_led0_open~0_combout\ <= NOT \led0_open~0_combout\;
...
-- Equation(s):
-- \led0_open~0_combout\ = ( \state~q\ & ( (!\key0_close~input_o\) # (\key1_open~input_o\) ) ) # ( !\state~q\ & ( (!\key0_close~input_o\ & \key1_open~input_o\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101000001010101011111010111100001010000010101010111110101111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_key0_close~input_o\,
