...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../embedded_system_case_4.sopcinfo
...
# Design Name 
# setting SOPC_NAME is embedded_system_case_4
SOPC_NAME := embedded_system_case_4
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1443183571
SOPC_SYSID_FLAG += --timestamp=1443183571
ELF_PATCH_FLAG  += --timestamp 1443183571
