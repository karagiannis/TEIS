...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../embedded_system_case_5B.sopcinfo
...
# Design Name 
# setting SOPC_NAME is embedded_system_case_5B
SOPC_NAME := embedded_system_case_5B
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1009040
SOPC_SYSID_FLAG += --sidp=0x1009040
ELF_PATCH_FLAG  += --sidp 0x1009040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1433407210
SOPC_SYSID_FLAG += --timestamp=1433407210
ELF_PATCH_FLAG  += --timestamp 1433407210
